...
export default function Home() {
  ...
  return (
    <>
      <div className="py-20">
        <p className="text-3xl text-white font-semibold text-center">helping data come to life</p>
        <p className="text-xl text-white/50 font-normal text-center mb-5">some of the projects I did in the field.</p>
            ...
            projects ? (
              projects.map((_, __) => (
                <a href={_.link} target="_blank" rel="noreferrer" key={__} className="bg-neutral-800/10 p-4 hover:bg-neutral-800/20 shadow-lg hover:shadow-xl transition-all duration-200 rounded-lg w-full">
                  <img alt="jt" src={_.image} width="1024" className="rounded-lg" height="512" />
