...
function MyApp({ Component, pageProps }) {
  ...
  return (<>
    <Head>
        <title>Joana Tavares</title>
        <link rel="shortcut icon" href="https://cdn.discordapp.com/attachments/919966397524738091/1058037349323378760/1612736474209.jpg" type="image/x-icon" ></link>
        ...
        <div style={{ zIndex: 99999 }} className="fixed bg-black/75 w-full h-screen flex justify-center items-center pointer-events-none">
            <div className="flex items-center gap-x-6 animate-pulse">
                <div className="text-center">
                    <p className="text-6xl mb-5 font-semibold">Joana Tavares</p>
